...
export class DatabaseStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: DatabaseStackProps) {
    ...
    userData.addCommands(
      ...
      "GRANT ALL PRIVILEGES ON *.* TO 'dms_user'@'%' IDENTIFIED BY 'DmsUser2024!';",
      "FLUSH PRIVILEGES;",
      "EOF",
      'mysql -u root < /tmp/setup.sql || true',
      // Enable binary logging for CDC (if supported)
    ...
    this.mysqlEndpoint = this.ec2Instance.instancePublicIp;
    ...
    // Outputs
    new cdk.CfnOutput(this, 'MySQLSourceIP', { value: this.ec2Instance.instancePublicIp, exportName: 'CloudShiftMySQLIP' });
    ...
    // Explicitly keep the public IP export alive to prevent CloudFormation cross-stack deadlock during transition
    this.exportValue(this.ec2Instance.instancePublicIp);
  }
}
